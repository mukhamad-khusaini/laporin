...
{
    /* 
            Saya ingin buat kode untuk controller penjualan kredit untuk aplikasi akuntansi saya. Buatkan kode untuk controller bagian store penjualan kredit dengan ketentuan berikut:
            1. Format data dari form request adalah sebagai berikut:
                account_type: "",
                sub_ledger: "",
                amount: "",
                receivable: "",
                transaction_date: new Date().toISOString().slice(0, 16),
                description: "",
            2. Apabila terdapat transaksi penjualan produk maka dicatat dalam satu transaction header dengan ayat pencatatan jurnal berikut:
                a. Piutang (D) = Harga jual
                b. Pendapatan (K) = Harga jual
                c. HPP (D) = Biaya produksi produk X
                d. Produk X (K) = Biaya produksi produk X
            3.  Apabila terdapat transaksi penjualan peralatan maka akan dicatat dengan 3 cara tergantung dari harga jualnya. Berikut ketentuannya:
                a. Apabila harga jual lebih rendah dari nilai buku alat X maka dicatat:
                    - Piutang (D) = Harga jual
                    - Beban penjualan (D) = nilai buku alat X - Harga jual
                    - Alat X (K) = Nilai buku alat X
                b. Apabila harga jual lebih tinggi dari nilai buku alat X maka dicatat:
                    - Piutang (D) = Harga jual
                    - Pendapatan lain (K) = Harga jual - nilai buku alat X
                    - Alat X (K) = Nilai buku alat X
                c. Apabila harga jual sama dengan nilai buku alat X maka dicatat:
                    - Piutang (D) = Harga jual
                    - Alat X (K) = Nilai buku alat X
            4. Apabila terdapat transaksi penjualan perlengkapan maka akan dicatat dengan 3 cara tergantung harga jualnya:
                a. Apabila harga jual lebih rendah dari nilai buku perlengkapan X maka dicatat:
                    - Piutang (D) = Harga jual
                    - Beban penjualan (D) = nilai buku perlengkapan X - Harga jual
                    - perlengkapan X (K) = Nilai buku perlengkapan X
                b. Apabila harga jual lebih tinggi dari nilai buku perlengkapan X maka dicatat:
                    - Piutang (D) = Harga jual
                    - Pendapatan lain (K) = Harga jual - nilai buku perlengkapan X
                    - perlengkapan X (K) = Nilai buku perlengkapan X
                c. Apabila harga jual sama dengan nilai buku perlengkapan X maka dicatat:
                    - Piutang (D) = Harga jual
                    - perlengkapan X (K) = Nilai buku perlengkapan X
            */
}
